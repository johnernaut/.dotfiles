...
_G.packer_plugins = {
  ...
  ["autoclose.nvim"] = {
    loaded = true,
    path = "/Users/john/.local/share/nvim/site/pack/packer/start/autoclose.nvim",
  ...
  ["nvim-treesitter-context"] = {
    loaded = true,
    path = "/Users/john/.local/share/nvim/site/pack/packer/start/nvim-treesitter-context",
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/Users/john/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
